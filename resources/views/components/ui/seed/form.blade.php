    ...
    <div class="card w-full h-full bg-white">
        ...
        <div class="card-body items-center">
            ...
            <div class="grid grid-cols-4 gap-3">
                ...
                <label class="input-group max-w-sm">
                    ...
                    <div class="form-control grow">
                        <input name="pic" type="text" placeholder="John Doe" class="input input-floating peer" />
                        <span class="input-floating-label">PIC</span>
                    </div>
                </label>
                <div class="form-control">
                    <input name="date" type="text" class="input max-w-sm" placeholder="Month DD, YYYY"
            ...
            <div class="grid grid-cols-3 mt-3 gap-3">
                ...
                <div>
                    <div class="join">
                        <input name="seed_qty" class="input join-item shrink w-full" type="number"
                            placeholder="00.00" />
