<x-app-layout>
    <div class="flex py-5">
        <div class="flex gap-4.5 mx-auto">
            <x-utils.stats title="Komoditas" model="Commodity" icon="leaf" color="success" />
            <x-utils.stats title="Distribusi Pupuk" model="FertilizerDistribution" icon="droplet" color="warning" />
            <x-utils.stats title="Distribusi Bibit" model="SeedDistribution" icon="droplet" color="primary" />
            <x-utils.stats title="Sekolah" model="School" icon="droplet" color="error" />
        </div>
    </div>
                ...
                <div class="flex flex-wrap items-center justify-between gap-2 py-4 pt-6">
                    ...
                    <nav class="flex items-center gap-x-1">
                        ...
                        <div class="flex items-center gap-x-1">
                          <button type="button" class="btn btn-sm btn-outline btn-square aria-[current='page']:text-border-primary aria-[current='page']:bg-primary/10" >1</button>
                          <button type="button" class="btn btn-sm btn-outline btn-square aria-[current='page']:text-border-primary aria-[current='page']:bg-primary/10" aria-current="page">2</button>
                          <button type="button" class="btn btn-sm btn-outline btn-square aria-[current='page']:text-border-primary aria-[current='page']:bg-primary/10" >3</button>
                        </div>
