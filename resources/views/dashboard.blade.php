<x-app-layout>
    ...
    <div class="flex py-5">
        <div class="flex gap-4.5 mx-auto">
            ...
            <x-utils.stats title="Distribusi Pupuk" model="FertilizerDistribution" icon="droplet" />
            <x-utils.stats title="Distribusi Bibit" model="SeedDistribution" icon="droplet" />
            <x-utils.stats title="Sekolah" model="School" icon="droplet" />
        </div>
    </div>
    ...
    <button class="m-3 btn btn-primary" id="notyf-custom-example">Custom notyf</button>
